...
from grasp_data_toolkit import read_write_data, mesh_processing, visualization, core_types
...
point_cloud = mesh_processing.convert_mesh_to_point_cloud(mesh_fn, with_normals=True)

# add them to object info
target_obj.point_cloud = point_cloud
o3d_pc = visualization._numpy_pc_to_o3d(point_cloud)
...
visualization.colorize_point_clouds(grasps_list)
visualization.show_o3d_point_clouds(grasps_list)
