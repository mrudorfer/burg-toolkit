...
class GripperWSG32(GripperBase):
    def __init__(self, bullet_client, gripper_size):
        r""" Initialization of WSG_32
        specific args for WSG_32:
        ...
        self._finger_close_distance = 0.001
    ...
    def load(self, basePosition):
        gripper_urdf = "assets/gripper/wsg_32/model.urdf"
    ...
    def close(self, mount_gripper_id, n_joints_before):
        self._bullet_client.setJointMotorControlArray(
            mount_gripper_id,
            [id+n_joints_before for id in self._moving_joint_ids],
            self._bullet_client.POSITION_CONTROL,
            targetVelocities=[self._grasp_speed, -self._grasp_speed], 
