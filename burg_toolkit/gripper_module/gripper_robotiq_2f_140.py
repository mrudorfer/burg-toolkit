...
class GripperRobotiq2F140(GripperBase):
    def __init__(self, bullet_client, gripper_size):
        r""" Initialization of robotiq-2f-140 gripper
    ...
    def load(self, basePosition):
        gripper_urdf = "assets/gripper/robotiq_2f_140/model.urdf"
    ...
    def open(self, mount_gripper_id, n_joints_before, open_scale):
        ...
        for _ in range(240 * 2):
            ...
            states_diff = np.abs(np.array(driver_pos) - self._driver_joint_lower)
